    ...
    <div style={{ backgroundColor: '#ffffff', minHeight: '100vh', padding: '40px 20px', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <button 
          ...
          style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', fontSize: '14px', fontWeight: '600', color: '#64748b', transition: '0.2s', marginBottom: '40px', background: 'transparent', border: 'none', cursor: 'pointer', padding: 0 }}
        >
